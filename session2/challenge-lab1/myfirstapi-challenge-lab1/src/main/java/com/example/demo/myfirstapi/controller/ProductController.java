...
public class ProductController {
    ...
    public Product updateProduct(@Valid @RequestBody Product updateProduct, @PathVariable Long product_id ){
        return productRepository.update(product_id, updateProduct);
    }
}
